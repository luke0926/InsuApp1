...
namespace InsuApp1.Data.Migrations
{
    ...
    [Migration("20230112190534_CloseBtn")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InsuApp1.Models.UserInsurance", b =>
                {
                    ...
                    b.Property<int?>("UserBackIdUserDetailViewId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserBackIdUserDetailViewId");
            ...
            modelBuilder.Entity("InsuApp1.Models.UserInsurance", b =>
                {
                    b.HasOne("InsuApp1.Models.UserDetailViewModel", "UserBackId")
                        .WithMany("UserInsurances")
                        .HasForeignKey("UserBackIdUserDetailViewId");

                    b.HasOne("InsuApp1.Models.User", "UserUserInsurance")
                        .WithMany()
                        .HasForeignKey("UserUserInsuranceUserId");

                    b.Navigation("UserBackId");
