...
namespace InsuApp1.Data.Migrations
{
    ...
    [Migration("20230327094630_EventIdUpdate")]
    partial class EventIdUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InsuApp1.Models.ChartValue", b =>
                {
                    b.Property<int>("ChartValueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ChartValueId"));

                    b.Property<int?>("ChartValueTotal")
                        .HasColumnType("int");

                    b.Property<string>("UserInsuranceName")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("ChartValueId");

                    b.ToTable("ChartValue");
                });
            ...
            modelBuilder.Entity("InsuApp1.Models.UserInsurance", b =>
                {
                    b.HasOne("InsuApp1.Models.MainInsurance", "MainInsurance")
                        .WithMany()
                        .HasForeignKey("MainInsuranceId");
            ...
            modelBuilder.Entity("InsuApp1.Models.UserInsuredEvent", b =>
                {
                    b.HasOne("InsuApp1.Models.MainInsuredEvent", "MainInsuredEvent")
                        .WithMany()
                        .HasForeignKey("MainInsuredEventId");
