...
namespace InsuApp1.Data.Migrations
{
    ...
    [Migration("20230123185248_MainInsu")]
    partial class MainInsu
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InsuApp1.Models.MainInsurance", b =>
                {
                    ...
                    b.Property<int?>("UserMainInsuranceUserId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserMainInsuranceUserId");
            ...
            modelBuilder.Entity("InsuApp1.Models.UserDetailViewModel", b =>
                {
                    ...
                    b.Property<int?>("MainInsurancedwMainInsuranceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MainInsurancedwMainInsuranceId");
            ...
            modelBuilder.Entity("InsuApp1.Models.MainInsurance", b =>
                {
                    b.HasOne("InsuApp1.Models.UserDetailViewModel", null)
                        .WithMany("MainInsurances")
                        .HasForeignKey("UserDetailViewModelUserDetailViewId");

                    b.HasOne("InsuApp1.Models.User", "UserMainInsurance")
                        .WithMany()
                        .HasForeignKey("UserMainInsuranceUserId");

                    b.Navigation("UserMainInsurance");
                });

            modelBuilder.Entity("InsuApp1.Models.UserDetailViewModel", b =>
                {
                    b.HasOne("InsuApp1.Models.MainInsurance", "MainInsurancedw")
                        .WithMany()
                        .HasForeignKey("MainInsurancedwMainInsuranceId");
